...
export default function TopHeader({ currentUser, isLoggedIn, onLogin, onRegister, searchProps }) {
        ...
        <div className="header-actions">
          {isLoggedIn ? (
            ...
            <div className="auth-buttons">
              ...
              <button onClick={handleRegisterClick} className="btn-auth btn-register">
                Register
              </button>
            </div>
          )}
